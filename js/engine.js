          ...
          case "startGame":
              ...
              var startInput = function(e) {
                  ...
                  if (key === 13) {
                      ...
                      succesSound = new sound("sounds/succes.wav");
                  }
              };
          ...
          case "startGame":
              ...
              for (row = 0; row < numRows; row++) {
                  for (col = 0; col < numCols; col++) {
                      ctx.drawImage(Resources.get(rowImages[row]), col * 65, row * 53);
                      // Text to display over the game board
                      ctx.fillStyle = 'White';
                      ctx.strokeStyle = 'black';
                      ctx.font = "60px Impact";
                      ctx.textAlign = "center";
                      ctx.strokeText("Parking spots", canvas.width / 2, canvas.height / 2.8);
                      ctx.fillText("Parking spots", canvas.width / 2, canvas.height / 2.8);
                      ctx.font = "20px Impact";
                      ctx.strokeText("Use the arrow keys to move", canvas.width / 2, canvas.height / 2.1);
                      ctx.fillText("Use the arrow keys to move", canvas.width / 2, canvas.height / 2.1);
                      ctx.font = "26px Impact";
                      ctx.strokeText("Press Enter To Start", canvas.width / 2, canvas.height / 1.7);
                      ctx.fillText("Press Enter To Start", canvas.width / 2, canvas.height / 1.7);
                  }
              }
              break;
          case "inGame":
